...
export default function JobDescriptionsList() {
  ...
  useEffect(() => {
    ...
    jobDescriptionService.getJobDescritions().then(result => setImages(result.data.data));}, []); // useEffect'in sadece bir kere çalışması için boş dependency array kullanıyoruz.
